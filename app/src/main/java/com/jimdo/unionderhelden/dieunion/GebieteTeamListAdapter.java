...
public class GebieteTeamListAdapter extends BaseAdapter {

    Context context;
    ArrayList<TWTeam> data;
    private static LayoutInflater inflater = null;

    public GebieteTeamListAdapter(Context context, ArrayList<TWTeam> data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        for(int a = 0; a < 5 ; a++){
            ...
            if(a >= nowTeam.charaktere.size()){
                ...
                switch (data.get(position).charaktere.get(a).getGear()) {
                    case 0:
                        break;
                    case 1:
                ...
                switch (data.get(position).charaktere.get(a).getName().replace("&quot;", "\"")) {
                    case "Ahsoka Tano":
